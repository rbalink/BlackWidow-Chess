...
import main.java.chess.engine.classic.board.BoardUtils;
import main.java.chess.engine.classic.board.Move;
import main.java.chess.engine.classic.board.Move.MoveFactory;
import main.java.chess.engine.classic.board.MoveTransition;
import main.java.chess.engine.classic.pieces.*;
import main.java.chess.engine.classic.player.ai.MoveStrategy;
import main.java.chess.engine.classic.player.ai.StockAlphaBeta;
import main.java.chess.pgn.FenUtilities;
...
public class TestCheckmate {
    ...
    public void testFoolsMate() {
        ...
        Assert.assertTrue(t4.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testScholarsMate() {
        ...
        Assert.assertTrue(t7.getMoveStatus().isDone());
        Assert.assertTrue(t7.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testLegalsMate() {
        ...
        Assert.assertTrue(t8.getMoveStatus().isDone());
        ...
        Assert.assertTrue(t9.getMoveStatus().isDone());
        ...
        Assert.assertTrue(t10.getMoveStatus().isDone());
        ...
        Assert.assertTrue(t12.getMoveStatus().isDone());
        ...
        Assert.assertTrue(t13.getMoveStatus().isDone());
        Assert.assertTrue(t13.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testGrecoGame() {
        ...
        Assert.assertTrue(t12.getMoveStatus().isDone());
        Assert.assertTrue(t12.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testOlympicGame() {
        ...
        Assert.assertTrue(t11.getMoveStatus().isDone());
        Assert.assertTrue(t11.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testAnotherGame() {
        ...
        Assert.assertTrue(t14.getMoveStatus().isDone());
        Assert.assertTrue(t14.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testSmotheredMate() {
        ...
        Assert.assertTrue(t8.getMoveStatus().isDone());
        Assert.assertTrue(t8.getToBoard().currentPlayer().isInCheckMate());
    ...
    public void testAnastasiaMate() {
        ...
        Assert.assertTrue(t1.getMoveStatus().isDone());
        Assert.assertTrue(t1.getToBoard().currentPlayer().isInCheckMate());
    }
