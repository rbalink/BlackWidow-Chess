package main.java.chess.engine.classic.player;
...
import main.java.chess.engine.classic.board.Move.KingSideCastleMove;
import main.java.chess.engine.classic.board.Move.QueenSideCastleMove;
import main.java.chess.engine.classic.pieces.Piece;
import main.java.chess.engine.classic.pieces.Rook;
...
import static main.java.chess.engine.classic.pieces.Piece.PieceType.ROOK;
               ...
               this.board.getPiece(57) == null) {
                ...
                if(queenSideRook != null && queenSideRook.isFirstMove()) {
                    if(calculateAttacksOnTile(58, opponentLegals).isEmpty() &&
                       calculateAttacksOnTile(59, opponentLegals).isEmpty() && queenSideRook.getPieceType() == ROOK) {
                        if(!BoardUtils.isKingPawnTrap(this.board, this.playerKing, 52)) {
